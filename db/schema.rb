...
ActiveRecord::Schema.define(version: 2019_10_28_210459) do
  ...
  create_table "messages", force: :cascade do |t|
    t.bigint "private_messages_id"
    t.bigint "sender_id"
    t.bigint "recipient_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["private_messages_id"], name: "index_messages_on_private_messages_id"
  ...
  add_foreign_key "messages", "private_messages", column: "private_messages_id"
